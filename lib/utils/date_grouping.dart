...
String shortDate10(String date) {
  return DateFormat("MMMM dd").format(DateTime.tryParse(date) ?? DateTime.now());
}

String shortDate11(String date) {
  return DateFormat("MMMM dd, yyyy").format(DateTime.tryParse(date) ?? DateTime.now());
}

String shortDate12(String date) {
  return DateFormat("EEEE").format(DateTime.tryParse(date) ?? DateTime.now());
}

String shortDate13(String date) {
  return DateFormat("MMMM, yyyy").format(DateTime.tryParse(date) ?? DateTime.now());
}

String shortDate14(String date) {
  return DateFormat("d").format(DateTime.tryParse(date) ?? DateTime.now());
}
